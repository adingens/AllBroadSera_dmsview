"""
Retrieve, process, and output data file for broad human sera MAP.
...
def main():
    ...
    antibodies = ['IDC0136', 'IDC0191', 'IDC208', 'IDC0245', 'IDC0337', 'IDC0396', 'IDC403', 'IDC0513', 'IDC0518', 'IDC0546', 'IDC561', 'IDF033', 'IDF065', 'IDF141', 'IDF147', 'QA013-2282dpi']
    chains = ["G", "B"]
    ...
    #added this to get positive only differential selection. This is hacky, but works. 
    df['mut_positive differential selection (median of reps)'] = df['mut_differential selection (median of reps)'].clip(lower=0)
    df.to_csv('process_BroadHumanSera.csv', index=False)
